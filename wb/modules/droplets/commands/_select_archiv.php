...
?><div class="droplets droplet-import block-outer modal-Dialog" id="openModal" draggable="true" style="overflow: hidden;">
    <div >
        <form action="<?php echo $ToolUrl}" method="post" name="droplets_form" enctype="multipart/form-data" >
            <span id="customConfirm" style="display: block; width: 71.225em; margin: auto 25%;">
...
<!--
domReady(function() {
    LoadOnFly('head', "<?php echo $sAddonThemeUrl}/css/fileupload.css");
    LoadOnFly('head', "<?php echo $sAddonThemeUrl}/css/dialogBox.css");
    LoadOnFly('head', "<?php echo $sAddonThemeUrl}/css/customAlert.css");
});
-->
</script>
